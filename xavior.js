/**
   * Recode By Cocopie
   * Contact Me on wa.me/628992029499
   * Follow https://github.com/iCocopie
...
_sewa.expiredCheck(xavior, sewa)
        ...
        if (m.message) {
            ...
            console.log(chalk.black(chalk.bgWhite('[ COCOBOTZ ]')), chalk.black(chalk.bgGreen(new Date)), chalk.black(chalk.bgBlue(budy || m.mtype)) + '\n' + chalk.magenta('=> Pesan Dari'), chalk.green(pushname), chalk.yellow(m.sender) + '\n' + chalk.blueBright('=> Pesan Di'), chalk.green(m.isGroup ? pushname : 'Private Chat', m.chat))
        }
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await xavior.setStatus(`${'©Cocopie'} | Runtime : ${runtime(uptime)}`)
	  ...
	  // Anti Link
        ...
        m.reply(`「 ANTI LINK 」\n\nKamu Terdeteksi Mengirim Link Group Wangsaff, Maaf Kamu Akan Di Kick 😅`)
        if (!isBotAdmins) return m.reply(`Bot Bukan Admin, Gabisa Nge Kick T_T`)
        let gclink = (`https://chat.whatsapp.com/`+await xavior.groupInviteCode(m.chat))
        let isLinkThisGc = new RegExp(gclink, 'i')
        let isgclink = isLinkThisGc.test(m.text)
        if (isgclink) return m.reply(`Ehh Maaf Gak Jadi, Karena Kamu Ngirim Link Group Ini 😅`)
        if (isAdmins) return m.reply(`Ehh Maaf Admin`)
        if (isCreator) return m.reply(`Ehh Maaf Owner`)
...
Ketik *nyerah* Untuk Surrend 🗿`
	    ...
	    xavior.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} Menolak Untuk By 1 Suit, Suit Dibatalkan`, m)
	    ...
	    xavior.sendText(m.chat, `Suit Telah Dikirimkan Ke Private Chat

@${roof.p.split`@`[0]} Dan 
@${roof.p2.split`@`[0]}

Silahkan Pilih Opsi Suit Di Chat Masing"
Klik https://wa.me/${botNumber.split`@`[0]}`, m, { mentions: [roof.p, roof.p2] })
	    ...
	    if (!roof.pilih && !roof.pilih2) xavior.sendText(m.chat, `Kedua Pemain Tidak Niat By 1,\nSesi Suit Dibatalkan`)
	    else if (!roof.pilih || !roof.pilih2) {
	    win = !roof.pilih ? roof.p2 : roof.p
	    xavior.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} Tidak Memilih Opsi Suit, Game Berakhir`, m)
	    }
	    delete this.suit[roof.id]
	    return !0
	    }, roof.timeout)
...
`.trim())
	    ...
	    case 'afk': {
                ...
                user.afkReason = text
                m.reply(`${m.pushName} Is Now In AFK Mode${text ? ' : ' + text : ''}`)
            }
            break	
        case 'ttc': case 'ttt': case 'tictactoe': {
            let TicTacToe = require("./lib/tictactoe")
            this.game = this.game ? this.game : {}
            if (Object.values(this.game).find(room => room.id.startsWith('tictactoe') && [room.game.playerX, room.game.playerO].includes(m.sender))) throw 'Kamu Masih Berada Didalam Game'
...
Ketik *nyerah* Untuk Surrend 🗿`
            ...
            m.reply('Menunggu Lawan' + (text ? ` Mengetik Command Dibawah Ini ${prefix}${command} ${text}` : ''))
            ...
            if (this.game) {
            delete this.game
            xavior.sendText(m.chat, `Berhasil Menghapus Session TicTacToe`, m)
            } else if (!this.game) {
            m.reply(`Session TicTacToe🎮 Tidak Tersedia`)
            } else throw '?'
            } catch (e) {
            m.reply('rusak')
            }
            ...
            let poin_lose = 10
            let timeout = 60000
            if (Object.values(this.suit).find(roof => roof.id.startsWith('suit') && [roof.p, roof.p2].includes(m.sender))) m.reply(`Selesaikan Sesi Suit Yang Sebelumnya`)
	    if (m.mentionedJid[0] === m.sender) return m.reply(`Tidak Bisa Bermain Dengan Diri Sendiri`)
            if (!m.mentionedJid[0]) return m.reply(`_Siapa Yang Ingin Kamu Ajak By 1?_\nTag Orangnya..\n\nContoh : ${prefix}suit @${owner[1]}`, m.chat, { mentions: [owner[1] + '@s.whatsapp.net'] })
            if (Object.values(this.suit).find(roof => roof.id.startsWith('suit') && [roof.p, roof.p2].includes(m.mentionedJid[0]))) throw `Orang Yang Kamu Tantang Sedang Bermain Suit Bersama Orang Lain :(`
            let id = 'suit_' + new Date() * 1
            let caption = `_*SUIT PvP*_

@${m.sender.split`@`[0]} Menantang @${m.mentionedJid[0].split`@`[0]} Untuk By 1
...
Silahkan @${m.mentionedJid[0].split`@`[0]} Untuk Ketik terima/tolak`
            ...
            case 'sc': {
                anu = `*Cek GitHub :*
https://github.com/iCocopie/CocoBotzV16

*Recode By : Cocopie*`
let btn = [{
                                urlButton: {
                                    displayText: 'Source Code',
                                    url: 'https://github.com/iCocopie/CocoBotzV16'
                                }
                            }]
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        xavior.send5ButImg(m.chat, anu, '©Cocopie', global.thumb, btn, global.thumb)
                        } else if (setbot.templateGif) {
                        xavior.send5ButGif(m.chat, anu, '©Cocopie', global.visoka, btn, global.thumb)
                        } else if (setbot.templateVid) {
                        xavior.send5ButVid(m.chat, anu, '©Cocopie', global.visoka, btn, global.thumb)
                        } else if (setbot.templateMsg) {
                        xavior.send5ButMsg(m.chat, anu, '©Cocopie', btn)
                        } else if (setbot.templateLocation) {
                        xavior.send5ButLoc(m.chat, anu, '©Cocopie', global.thumb, btn)
                        }
                     }
            break
            case 'chat': {
	    ...
	    case 'family100': {
            ...
            break
            case 'tebak': {
                if (!text) throw `Example : ${prefix + command} gambar\n\nOption : \n1. lagu\n2. gambar\n3. kata\n4. kalimat\n5. lirik\n6.lontong`
                if (args[0] === "lagu") {
...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, jawab, '©Cocopie', m, {mentions: ments})
            }
            break
            case 'jadian': {
            if (!m.isGroup) throw mess.group
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, jawab, '©Cocopie', m, {mentions: menst})
            }
            break
            case 'react': {
                if (!isCreator) throw mess.owner
...
let teks = `══✪〘 *👥 Tag All* 〙✪══
 ...
 ➲ *Pesan : ${q ? q : 'kosong'}*\n\n`
	    ...
	    break
            ...
            if (!text) throw `Masukkan Alasan Melakukan Vote, Example: *${prefix + command} Kudeta*`
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            break
               case 'group': case 'grup': {
                ...
                let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `Mode Group`, '©Cocopie', m)
            ...
            case 'editinfo': {
             ...
             let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `Mode Edit Info`, '©Cocopie', m)
            ...
            case 'antilink': {
                ...
                m.reply(`Antilink Tidak Aktif !`)
                 ...
                 let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `Mode Antilink`, '©Cocopie', m)
                }
             }
             break
             case 'mute': {
                ...
                m.reply(`${'©XaviorOfc'} telah di unmute di group ini !`)
                 ...
                 let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `Mute Bot`, '©Cocopie', m)
                }
             }
             break
            ...
            case 'ephemeral': {
                ...
                xavior.sendListMsg(m.chat, `Please select the following Ephemeral Options List !`, '©Cocopie', `Hello Admin ${groupMetadata.subject}`, `Click Here`, sections, m)
                }
            }
            break
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    displayText: '️Source Code',
                                    url: 'https://github.com/iCocopie/CocoBotzV16'
                                }
                                }, {
                                urlButton: {
                                    displayText: 'Website Bot',
                                    url: 'https://github.com/iCocopie'
                                }
                                }, {
                                quickReplyButton: {
                                    displayText: 'Menu',
                      ...
                      xavior.send5ButImg(i, txt, '©Cocopie', global.thumb, btn)
                    }
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                      ...
                      let txt = `「 Broadcast Bot 」\n\n${text}`
                      xavior.send5ButImg(yoi, txt, '©Cocopie', global.thumb, btn)
		}
...
⭔ Url : ${anu.url}`,
		...
		let { quotesAnime } = require('./lib/scraper')
                ...
                let buttonMessage = {
                    ...
                    footer: 'Press The Button Bellow',
                    buttons: buttons,
                    headerType: 2
                }
                xavior.sendMessage(m.chat, buttonMessage, { quoted: m })
	    ...
	    case 'anonymous': {
            ...
            case 'mulai': case 'start': {
                ...
                if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `\`\`\`Kamu Masih Berada Di dalam Sesi Anonymous, Tekan Button Dibawah Ini Untuk Menghentikan Sesi Anonymous Anda\`\`\``, '©Cocopie', m)
                    throw false
                }
                ...
                if (room) {
                    ...
                    await xavior.sendButtonText(room.a, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, '©Cocopie', m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await xavior.sendButtonText(room.b, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, '©Cocopie', m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `\`\`\`Mohon Tunggu Sedang Mencari Partner\`\`\``, '©Cocopie', m)
                }
                break
            }
...
⭔ Detail: ${detail}`
            ...
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                xavior.sendListMsg(m.chat, `Please select the menu you want to change!`, '©Cocopie', `Hello Owner !`, `Click Here`, sections, m)
                }
            }
            break
...
╰────
╭─[ *MINAT CHAT* ]
├  🪀 wa.me/628992029499?text=SEWABOT
╰────
╭─[ *PAYMENT* ]
├  SHOPPEPAY
├  DANA
...
let btn = [{
            ...
            break
case 'gopay': {
                xavior.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/2fec41fdeadc838ae7661.png' }, caption: `08992029499` }, { quoted: m })
            }
            break
case 'dana': {
                xavior.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/2fec41fdeadc838ae7661.png' }, caption: `Dana` }, { quoted: m })
            }
            break
case 'pulsa': {
m.reply('08992029499')
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    title: `Jika ${pushname} Lagi Gabut Klik Aja Kotak Dibawah\n`,
                    ...
                    sections: [{
									...
									{
										"title": "Voice Changer",
										"description": "Menampilkan VC Menu",
									...
									{
										"title": "Contributor",
										"description": "Big Thanks To You All",
...
let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        xavior.send5ButImg(m.chat, anu, '©Command', global.thumb, btn, global.thumb)
                        } else if (setbot.templateGif) {
                        xavior.send5ButGif(m.chat, anu, '©Command', global.visoka, btn, global.thumb)
                        } else if (setbot.templateVid) {
                        xavior.send5ButVid(m.chat, anu, '©Command', global.visoka, btn, global.thumb)
                        } else if (setbot.templateMsg) {
                        xavior.send5ButMsg(m.chat, anu, '©Command', btn)
                        } else if (setbot.templateLocation) {
                        xavior.send5ButLoc(m.chat, anu, '©Cocopie', global.thumb, btn)
                        }
                     }
...
let btn = [{
            ...
            case 'menu': case 'help': case '?': {
                anu = `${ucapanWaktu} ${pushname}\n\nGwehj ${global.namabot}, Bot Ini Gak Secanggih Bot Ditahun 3000.\nKarena ${global.namabot} Adalah Hasil Begadang Cocopie.\nKalau Kalian Pake Botnya Tapi Ngelag, Itu Karena Kalian Wibu🗿\n\nKlik Aja Button Di Bawah Cuy 😅`
                let btn = [{
                                urlButton: {
                                    displayText: '️GitHub',
                                    url: 'https://github.com/iCocopie'
...
*TENGKYU BUAT YANG UDAH MAU DONASI 🤗*`
let btn = [{
                                urlButton: {
                                    displayText: '️GitHub',
                                    url: 'https://github.com/iCocopie'
...
🤖 : Script Gak Dijual, Tapi Bisa Cari Di GitHub iCocopie
